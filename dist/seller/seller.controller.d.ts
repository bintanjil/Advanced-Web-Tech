...
export declare class SellerController {
    ...
    getAllSellers(req: any): Promise<import("./seller.entity").Seller[]>;
    ...
    searchSellers(query: string, req: any): Promise<import("./seller.entity").Seller[]>;
    ...
    getActiveSellers(req: any): Promise<import("./seller.entity").Seller[]>;
}
