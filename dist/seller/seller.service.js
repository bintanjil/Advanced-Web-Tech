...
let SellerService = SellerService_1 = class SellerService {
    ...
    constructor(sellerRepository, adminService, mailService) {
    ...
    async createSeller(addSellerDto, adminId) {
        ...
        try {
            await this.mailService.sendSellerWelcomeEmail(savedSeller.email, addSellerDto.password);
        }
        catch (error) {
...
exports.SellerService = SellerService = SellerService_1 = __decorate([
    ...
    __param(1, (0, common_1.Inject)((0, common_1.forwardRef)(() => admin_service_1.AdminService))),
