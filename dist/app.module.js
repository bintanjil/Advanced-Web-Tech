    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRoot({
                ...
                password: 'admin',
                database: 'ecommerce',
                entities: [admin_entity_1.Admin, customer_entity_1.Customer, seller_entity_1.Seller, product_entity_1.Product, order_entity_1.Order, order_item_entity_1.OrderItem, address_entity_1.Address],
                synchronize: true,
            }),
